...
local user_opts = {
	...
	font = 'lato',	-- default osc font
    seekbarstyle = 'bar',
    seekbarhandlesize = 0,	-- size ratio of the slider handle, range 0 ~ 1
    ...
    language = 'fra',			-- eng=English, chs=Chinese
}
...
local language = {
	['eng'] = {
        ...
        ['fra'] = {
            welcome = '{\\fs24\\1c&H0&\\3c&HFFFFFF&}Faire glisser des fichiers ou des URLs à jouer.',  -- this text appears when mpv >
                off = 'OFF',
                na = 'n/a',
                none = 'none',
                video = 'Vidéo',
...
local osc_styles = {
	...
	SeekbarFg = '{\\blur1\\bord1\\1c&H1C1CB7&}',
    ...
    Clock = '{\\blur0\\bord0\\1c&HFFFFFF&\\3c&HFFFFFF&\\fs72\\fnlato}',
    ClockColon = '{\\blur0\\bord0\\1c&H1C1CB7&\\3c&H7373E5&\\fs72\\fnlato}',
...
function window_controls()
    ...
    ne.content = os.date('%H %M')
    ne.eventresponder['mbtn_left_up'] =
        function ()  end
    lo = add_layout('clock')
    lo.geometry = {x = 0.95*osc_param.playresx, y = 0.05*osc_param.playresy, an = 5, w = 0, h = 0}
    lo.style = osc_styles.Clock
    lo.alpha[3] = 0

    -- Clock "|" 
    ne = new_element('clockcolon', 'button')
    ne.content = "|"
    ne.eventresponder['mbtn_left_up'] =
        function ()  end
    lo = add_layout('clockcolon')
    lo.geometry = {x = 0.95*osc_param.playresx+1, y = 0.05*osc_param.playresy, an = 5, w = 0, h = 0}
    lo.style = osc_styles.ClockColon
    lo.alpha[3] = 0
...
layouts = function ()
    ...
    lo.geometry = {x = refX , y = refY - 96 , an = 5, w = osc_geo.w - 50, h = 25}
    lo.layer = 13
    ...
    lo.geometry = {x = refX, y = refY - 96 , an = 5, w = osc_geo.w - 50, h = 40}
    ...
    lo.geometry = {x = 20, y = refY - 135, an = 7, w = 64, h = 20}
    lo.style = osc_styles.Time	
	

    lo = add_layout('tc_right')
    lo.geometry = {x = osc_geo.w - 25, y = refY - 135, an = 9, w = 64, h = 20}
    lo.style = osc_styles.Time	
